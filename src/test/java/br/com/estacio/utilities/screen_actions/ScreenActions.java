...
public class ScreenActions {
	...
	/**
	 * Execute the initElements of the Page Factory with a field decorator timeout equals to the param seconds
	 * @param page
	 * @param seconds
	 */
	...
	/**
	 * Execute the initElements of the Page Factory with a field decorator timeout equals to the default in BaseConstants
	 * @param page
	 */
	public void initElements(Object page) {
		initElements(page, BaseConstants.DEFAULT_DURATION);
	}
}
